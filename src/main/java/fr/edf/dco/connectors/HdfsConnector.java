...
public class HdfsConnector  {
	 ...
	 * @param b 
	 */
	public HdfsConnector(String coreSiteFile, String hdfsSiteFile, boolean b) {
	...
	private void configure() throws IOException {    
		...
		conf.set("fs.hdfs.impl", org.apache.hadoop.fs.DF.class.getName());
//		conf.set("fs.hdfs.impl", org.apache.hadoop.fs.DistributedFileSystem.class.getName());
